...
--
-- NOTE (schemachange split): O2C_WH and O2C_DB are created by Terraform
-- (terraform/04_warehouse.tf, terraform/05_database.tf), not here — this migration
-- only USEs them and owns everything inside the database (schemas, tables).
-- Run `terraform apply` before the first `schemachange deploy`.
-- ============================================================
